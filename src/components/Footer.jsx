...
const Footer = () => {
  return (
    <footer className="relative z-10 bg-dark pt-20 pb-12 lg:pt-[100px] lg:pb-16">
      <div className="container px-4 mx-auto">
        <div className="flex flex-wrap -mx-4">
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div className="w-full mb-10">
              <Link
                to="/"
                className="mb-6 inline-block max-w-[80px]"
              >
                <img
                  src="/logo.png"
                  alt="logo"
              ...
              <p className="mb-8 max-w-[270px] text-base leading-relaxed text-gray-7">
                Nền tảng nhật ký cá nhân hiện đại, giúp bạn lưu giữ những khoảnh khắc đáng nhớ 
                và chia sẻ câu chuyện của mình với cộng đồng.
              </p>
              <div className="flex items-center -mx-3">
                <a
                  href="javascript:void(0)"
                  className="px-3 text-gray-7 hover:text-primary transition-colors duration-300"
                >
                  <svg
                    width="22"
                    height="22"
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-2/12 xl:w-2/12">
            <div className="w-full mb-10">
              <h4 className="mb-9 text-lg font-semibold text-white">Trang Chủ</h4>
              <ul className="space-y-2">
                <li>
                  <Link
                    to="/"
                    className="inline-block text-base text-gray-7 hover:text-primary transition-colors duration-300"
                  >
                    Trang chủ
                  </Link>
                </li>
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-2/12">
            <div className="w-full mb-10">
              <h4 className="mb-9 text-lg font-semibold text-white">Hướng Dẫn</h4>
              <ul className="space-y-2">
                <li>
                  <a
                    href="#features"
          ...
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-3/12 xl:w-5/12">
            <div className="w-full mb-10">
              <h4 className="mb-9 text-lg font-semibold text-white">Tài Khoản</h4>
              <ul className="space-y-2">
                <li>
                  <Link
                    to="/signin"
        ...
        <div className="h-px mb-8 mt-8 bg-white/10"></div>
        
        <div className="pb-8 text-center">
          <p className="text-base text-gray-7">
            &copy; {new Date().getFullYear()} Nhật Ký Cá Nhân. Made with <span className="text-primary">❤️</span> for preserving memories.
          </p>
        </div>
      </div>
    </footer>
